  ...
  return (
    <ParentShell>
      <div className="w-full">
        ...
        <div className="space-y-5 bg-white px-4 py-5 sm:px-5 lg:px-6">
          <section className="rounded-[16px] border border-[#eceef2] bg-[#fafafa] p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#6b7280]">Last changed 6 months ago</p>
              </div>
            </div>
            ...
            <div className="mt-5 rounded-[12px] border border-[#e5e7eb] bg-white px-4 py-4">
              <div className="space-y-3 text-[14px]">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="font-medium text-[#4b5563]">January 10, 2024</span>
                </div>
                <div className="flex items-center justify-between gap-4">
                  <span className="text-[#6b7280]">Current Plan</span>
                  <span className="font-medium text-[#d61c3f]">Family Plan</span>
                </div>
                <div className="flex items-center justify-between gap-4">
                  <span className="text-[#6b7280]">Students Enrolled</span>
                  <span className="font-medium text-[#4b5563]">2 of 3</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-[16px] border border-[#f3cfd6] bg-white p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
            ...
            <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-[13px] text-[#6b7280]">
                  Permanently remove your account and all student data.
                </p>
              </div>
